...
#+begin_src emacs-lisp
  ...
  Inserts placeholder `[[URL][Fetching title...]]` and updates it asynchronously.
  If a URL was present at point, it is removed and replaced by the org link."
    (interactive)
                           ...
                           (progn
                             (when (buffer-live-p orig-buf)
                               (with-current-buffer orig-buf
                                 (my/org--replace-marked-region-with start-marker end-marker (format "[[%s]]" maybe-url))))
