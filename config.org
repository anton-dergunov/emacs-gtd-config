...
(add-hook 'org-agenda-finalize-hook #'ps/org-conflicts--agenda-schedule-check)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (define-key my-menu-bar-menu [my-cmd-conflicts]
              '(menu-item "Check Conflicts" ps/org-show-conflicts :help "Show scheduling conflicts in org files"))
#+end_src
