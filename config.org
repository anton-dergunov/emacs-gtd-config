...
#+begin_src emacs-lisp
  ...
  (defun my/org-insert-link-from-url ()
    "Prompt for URL and insert [[URL][title]] via org-cliplink."
    (interactive)
  ...
  ;; Bind to F6
  (global-set-key (kbd "<f6>") #'my/org-insert-link-from-url)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (define-key my-menu-bar-menu [my-cmd0]
              '(menu-item "Insert URL (auto-title)" my/org-insert-link-from-url :help "Insert URL (auto-title)"))  
#+end_src
