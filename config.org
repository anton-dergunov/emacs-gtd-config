...
#+begin_src emacs-lisp
  (use-package org-modern
    ...
    (set-face-attribute 'org-modern-date-active nil :height 1.2)
    (set-face-attribute 'org-modern-time-active nil :height 1.2)
    (set-face-attribute 'org-modern-date-inactive nil :height 1.2)
    (set-face-attribute 'org-modern-time-inactive nil :height 1.2)
    ;; Disable modern bullets
    (setq org-modern-star nil)

    ;; Monochrome TODO keywords
    (custom-set-faces
     '(org-todo ((t (:foreground "gainsboro" :background "gray20" :weight bold))))
     '(org-done ((t (:foreground "gainsboro" :background "gray20" :weight bold))))
